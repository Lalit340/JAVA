...
/* A demo show how to use HXTT Text (CSV) in applet */
public class testApplet extends java.applet.Applet implements KeyListener,MouseListener
{
    ...
    public void init()
    {
        ...
        add(new Label("Enter URL(e.g., jdbc:Text://localhost:8029/datafiles and jdbc:Text:/c:/datafiles) "));
        urlTextField = new TextField(30);
        urlTextField.setText("jdbc:Text://localhost:8029/.");
