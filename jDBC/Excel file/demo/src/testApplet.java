...
/* A demo show how to use HXTT Excel in applet */
public class testApplet extends java.applet.Applet implements KeyListener,MouseListener
{
    ...
    public void init()
    {
        ...
        add(new Label("Enter URL(e.g., jdbc:Excel://localhost:8029/datafiles and jdbc:Excel:/c:/datafiles) "));
        urlTextField = new TextField(30);
        urlTextField.setText("jdbc:Excel://localhost:8029/.");
